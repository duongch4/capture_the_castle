...
//bool MeshComponent::init(int width, int height) {
...
//}
//
//bool MeshComponent::updateSprite(int textureWidth, int textureHeight, int spriteWidth, int spriteHeight, int spriteIndexX, int spriteIndexY, int spriteGap) {
//	// The position corresponds to the center of the texture.
//	float wr = textureWidth * 0.5f;
//	float hr = textureHeight * 0.5f;
//
