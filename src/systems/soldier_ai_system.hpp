...
//#include <iostream>
//
//#include <systems/soldier_spawn_system.hpp>
//
...
//	};
//
//	const size_t MAX_SOLDIERS = SoldierSpawnSystem::get_max_soldiers();
...
//	void chase(float& distance_1, float& distance_2, Entity& soldier, float& speed, float& elapsed_ms);
...
//	bool is_within_soldier_region(Tile tile);
//	bool is_within_soldier_region(int idx_row, int idx_col, vec2 pos);
//	void move_on_path(std::vector<Tile> path, float& speed, float& elapsed_ms, vec2& soldier_pos);
//};
//
//
